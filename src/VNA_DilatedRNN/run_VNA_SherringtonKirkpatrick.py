...
Title : Implementation of Variational Neural Annealing for the Sherrington Kirkpatrick Model
Description : This code uses a Dilated RNN cell to implement variational neural annealing both classical
and quantum on the Sherrington-Kirkpatrick model.
"""
#-----------------------------------------------------------------------------------------------------------
